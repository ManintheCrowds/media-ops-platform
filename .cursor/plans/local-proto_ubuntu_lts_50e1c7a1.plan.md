...
- **Other `*.ps1`:** `verify_ollama_llm.ps1`, `verify_nim_llm.ps1`, `mcp_warmup.ps1`, `check_intent_checksum.ps1`, `run_stealth_regtest.ps1`, `run_daggr_registry.ps1`, `import_operator_alignment_opengrimoire.ps1`, `sync_harness_to_vault.ps1`, `rotate_audit_logs.ps1`, `run_nim_smoke.ps1`, `run_vehicle_recovery_scheduled.ps1` (+ `.cmd` wrapper). MVP covers the first four categories; rest = backlog.
