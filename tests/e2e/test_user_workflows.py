...
class TestUserWorkflows:
    ...
    def test_user_registration_to_login_workflow(self, client):
        ...
        login_response = client.post(
            "/api/auth/token",
            data={"username": "workflowuser", "password": "SecurePass123!@#"},
        )
    ...
    def test_user_service_access_workflow(self, client, db_session):
        ...
        login_response = client.post(
            "/api/auth/token",
            data={"username": "serviceuser", "password": "SecurePass123!@#"},
        )
        ...
        health_response = client.get(
            "/api/health/services", headers={"Authorization": f"Bearer {token}"}
        )
