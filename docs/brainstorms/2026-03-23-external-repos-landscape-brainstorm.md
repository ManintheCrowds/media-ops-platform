...
Structured comparison of TrustGraph, CyberGym, GSD, learn-claude-code, MoneyPrinterV2, and Maestro against OpenAtlas / OpenHarness / local-proto intent, plus SCP-then-archive workflow for third-party text and YouTube transcripts.
...
- Third-party README excerpts and transcripts are **untrusted** at the harness boundary: use `scp_run_pipeline(content, sink='llm_context')` or the chain in `D:/portfolio-harness/OpenAtlas/docs/agent/SCP_LLM_INGESTION_CHECKLIST.md` before LLM ingest or durable archive.
...
| [Maestro](https://github.com/mobile-dev-inc/Maestro) | YAML **mobile/web E2E**, resilient flows | **Already reflected** in OpenAtlas: Playwright = CI truth; Maestro = optional YAML smoke — `INTEGRATION_PATHS.md`, `ARCHITECTURE_REST_CONTRACT.md` | No change required unless you want **more** Maestro coverage; keep **Playwright** as gate |
...
| Artifact | Path |
|----------|------|
| OpenAtlas GUI principles | `D:/portfolio-harness/OpenAtlas/docs/GUI_WORKBENCH_PRINCIPLES.md` |
| Eval: promptfoo + CyberGym + CI | `D:/portfolio-harness/OpenAtlas/docs/EVAL_PROMPTFOO_CYBERGYM.md` |
...
- INTEGRATION_PATHS: `D:/portfolio-harness/OpenAtlas/docs/agent/INTEGRATION_PATHS.md`
