...
overview: Document three repeatable ripgrep inventories (with Windows PowerShell equivalents), the actual file lists as of 2026-03-23 for OpenGrimoire + portfolio-harness, anchor docs, and how to narrow the noisy third query for an action-parity–only starter set.
todos:
  - id: document-commands
    content: Keep bash + PowerShell rg commands in one place (plan doc or OpenGrimoire CONTRIBUTING pointer)
    status: completed
  - id: narrow-query3
...
```powershell
Set-Location D:\portfolio-harness\OpenGrimoire
rg -l "agent-native|parity|capabilities" --glob "*.md" --glob "*.{ts,tsx}"
rg -l "api/capabilities|/api/" src/app/api
...
**Markdown (10 files)** — all under `OpenGrimoire/`:


| Path                                                                                                                                                        |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `[CONTRIBUTING.md](D:/portfolio-harness/OpenGrimoire/CONTRIBUTING.md)`                                                                                         |
| `[docs/AGENT_NATIVE_AUDIT_OPENGRIMOIRE.md](D:/portfolio-harness/OpenGrimoire/docs/AGENT_NATIVE_AUDIT_OPENGRIMOIRE.md)`                                               |
| `[docs/ARCHITECTURE_REST_CONTRACT.md](D:/portfolio-harness/OpenGrimoire/docs/ARCHITECTURE_REST_CONTRACT.md)`                                                   |
| `[docs/LOCAL_FIRST_NEWS_POINTER.md](D:/portfolio-harness/OpenGrimoire/docs/LOCAL_FIRST_NEWS_POINTER.md)`                                                       |
| `[docs/OPENGRIMOIRE_SYSTEMS_INVENTORY.md](D:/portfolio-harness/OpenGrimoire/docs/OPENGRIMOIRE_SYSTEMS_INVENTORY.md)`                                                 |
| `[docs/agent/INTEGRATION_PATHS.md](D:/portfolio-harness/OpenGrimoire/docs/agent/INTEGRATION_PATHS.md)`                                                         |
| `[docs/plans/SCOPE_OPENGRIMOIRE_FULL_REVIEW.md](D:/portfolio-harness/OpenGrimoire/docs/plans/SCOPE_OPENGRIMOIRE_FULL_REVIEW.md)`                                     |
| `[docs/plans/2026-03-19-opengrimoire-alignment-context-design.md](D:/portfolio-harness/OpenGrimoire/docs/plans/2026-03-19-opengrimoire-alignment-context-design.md)` |
| `[docs/plans/2026-03-19-opengrimoire-agent-native-audit.md](D:/portfolio-harness/OpenGrimoire/docs/plans/2026-03-19-opengrimoire-agent-native-audit.md)`             |
| `[e2e/maestro/README.md](D:/portfolio-harness/OpenGrimoire/e2e/maestro/README.md)`                                                                             |
...
| Path                                                                                                                                      | Note                                                                                                                                                              |
| ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `[src/app/api/capabilities/route.ts](D:/portfolio-harness/OpenGrimoire/src/app/api/capabilities/route.ts)`                                   | Canonical **capabilities manifest** (keep in sync with API changes).                                                                                              |
| `[src/components/SurveyForm/steps/MotivationStep.tsx](D:/portfolio-harness/OpenGrimoire/src/components/SurveyForm/steps/MotivationStep.tsx)` | **Weak signal:** likely matches the word “capabilities” in survey copy, not REST/MCP parity. Treat as optional for parity audits or exclude via stricter pattern. |
...
- `[src/app/api/capabilities/route.ts](D:/portfolio-harness/OpenGrimoire/src/app/api/capabilities/route.ts)`
- `[src/app/api/alignment-context/route.ts](D:/portfolio-harness/OpenGrimoire/src/app/api/alignment-context/route.ts)`
- `[src/app/api/alignment-context/[id]/route.ts](D:/portfolio-harness/OpenGrimoire/src/app/api/alignment-context/[id]/route.ts)`
...
| Anchor                                                                                                                                                          | Status                                                                 |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `[OpenGrimoire/docs/AGENT_NATIVE_AUDIT_OPENGRIMOIRE.md](D:/portfolio-harness/OpenGrimoire/docs/AGENT_NATIVE_AUDIT_OPENGRIMOIRE.md)`                                         | Gap report; **§1 Action parity** table + score.                        |
| `[OpenGrimoire/src/app/api/capabilities/route.ts](D:/portfolio-harness/OpenGrimoire/src/app/api/capabilities/route.ts)`                                               | Machine-readable route manifest (update with API PRs per file header). |
| `[OpenGrimoire/docs/ARCHITECTURE_REST_CONTRACT.md](D:/portfolio-harness/OpenGrimoire/docs/ARCHITECTURE_REST_CONTRACT.md)`                                             | Normative REST contract (referenced by audit + CONTRIBUTING).          |
...
1. **OpenGrimoire PRs that touch `src/app/api/`:** Update `[capabilities/route.ts](D:/portfolio-harness/OpenGrimoire/src/app/api/capabilities/route.ts)` and `[ARCHITECTURE_REST_CONTRACT.md](D:/portfolio-harness/OpenGrimoire/docs/ARCHITECTURE_REST_CONTRACT.md)` in the same change (per route header and CONTRIBUTING).
...
- Add a **one-page** `OpenGrimoire/docs/ACTION_PARITY_FILE_INDEX.md` (or a row in an existing plan) that embeds this grep recipe + curated lists so agents do not re-run noisy Query 3 blindly.
