...
- **[PORTFOLIO_README_TEMPLATE.md](PORTFOLIO_README_TEMPLATE.md)** — Reusable README structure (hero, problem/solution/impact, features, tech stack, quick start, docs, testing, license) and a portfolio-readiness checklist for any repo.
